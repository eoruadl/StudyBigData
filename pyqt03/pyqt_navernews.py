...
class qTemplate(QWidget):
    ...
    def makeTable(self, result):
        # 테이블위젯 설정
        # self.tblResult.selectionMode(QAbstractItemView.SingleSelection)
    ...
    def getNaverSearch(self, keyword, search, start, display):
        ...
        # 네이버 인증 추가
        req.add_header('X-Naver-Client-Id', '6MP0dWXkfGVp77EK5E7r')
        req.add_header('X-Naver-Client-Secret', 'hOUgTX5FKG')
